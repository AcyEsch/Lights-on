...
public class FXMLNewLevelController implements Initializable 
{ 
...
//////////////////////////////LÄDT//////////////////////////////////////////////    
    ...
    //!!!!!!!!!!!!!!!!!Spezifische Eigenschaften des Levels!!!!!!!!!!!!!!!!!!
        ...
        Bahn schalter = new Bahn(700,300,780,300, true, true);    
        schalter.setStrokeWidth(20.0);
        schalter.setStroke(AQUAMARINE);
        Kugel kugel = new Kugel(radius, 600, 300, true);
        Tooltip t = new Tooltip();
        t.setText("Drag the ball and the switch wherever you wish.");
        Tooltip.install(kugel, t);
        Tooltip.install(schalter, t);
...
//        dialog.show();
               ...
               Label text = new Label("You turned the light on!");
               text.setScaleX(2);
               text.setScaleY(1.5);
                ...
                public void handle(ActionEvent e) {
                 ...
                 Scene scene = gridPane.getScene();
                    try {
                        scene.setRoot(FXMLLoader.load(getClass().getResource("/gui/FXMLNewLevel.fxml")));
                    } catch (IOException ex) {
                        Logger.getLogger(FXMLGameController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                   dialog.close();
                ...
                dialogVbox.getChildren().addAll(button);
    ...
    public void gameOverMessage(){
        tl.stop();
            Stage gameOver=new Stage();
               ...
               Button repeat_btn = new Button(" Restart ");
