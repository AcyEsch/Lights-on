...
//        stage.show();
 //  System.out.println("gogogogogoogogogg" );
    ...
    private void load () 
    { 
   Bahn bahn4= new Bahn(50, 150, 250, 250, true,false);//Negative Steigung   x1 y1 x2 y2   
    Bahn bahn3= new Bahn(450, 150, 250, 550, false,false);//Negative Steigung   x1 y1 x2 y2  
   
    Bahn bahn2 = new Bahn(410,650, 550,450, true, false);
